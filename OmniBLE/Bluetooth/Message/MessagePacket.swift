...
struct MessagePacket {
    ...
    static func parse(payload: Data) throws -> MessagePacket {
        ...
        return MessagePacket(
            type: type,
            source: Id(payload.subdata(in: 8..<12)),
            destination: Id(payload.subdata(in: 12..<16)),
    ...
    let version: Int16
    init(type: MessageType, source: Id, destination: Id, payload: Data, sequenceNumber: UInt8, ack: Bool = false, ackNumber: UInt8 = 0, eqos: Int16 = 0, priority: Bool = false, lastMessage: Bool = false, gateway: Bool = false, sas: Bool = true, tfs: Bool = false, version: Int16 = 0) {
        self.type = type
        self.source = source
